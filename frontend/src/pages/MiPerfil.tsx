/**
 * Página MiPerfil de la aplicación FitManager.
 *
...
import { z } from 'zod'
import { useMiPerfil, useCambiarPasswordStaff } from '@/hooks/use-mi-perfil'
        ...
        <div className="bg-surface border border-border rounded-card p-6">
          ...
          {isLoading ? (
            ...
            <div className="space-y-3">
              ...
              <div>
                <p className="text-xs text-muted-dark uppercase tracking-wider">Rol</p>
                <p className="text-foreground font-medium">{perfil?.rol}</p>
              </div>
              <div>
              ...
              {perfil?.fecha_creacion && (
                <div>
                  ...
                  <p className="text-foreground font-medium">{formatFecha(perfil.fecha_creacion)}</p>
                </div>
              )}
            </div>
          )}
        ...
        <div className="bg-surface border border-border rounded-card p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input type="password" {...register('contrasena_actual')} placeholder="••••••••" autoComplete="current-password" />
            ...
            <div className="space-y-1.5">
              ...
              <Input type="password" {...register('confirmar')} placeholder="Repite la nueva contraseña" autoComplete="new-password" />
