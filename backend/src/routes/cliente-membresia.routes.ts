/**
 * Rutas Express del módulo cliente-membresia.routes.
 *
...
clienteMembresiaRouter.post(
  '/cambiar-plan',
  authorize('Administrador', 'Recepcionista'),
  clienteMembresiaController.cambiarPlan,
)
...
clienteMembresiaRouter.post(
  '/:id/cancelar',
  authorize('Administrador', 'Recepcionista'),
  clienteMembresiaController.cancelar,
)
clienteMembresiaRouter.get(
  '/:id/estado',
  authorize('Administrador', 'Recepcionista'),
  clienteMembresiaController.consultarEstado,
)
clienteMembresiaRouter.post(
  '/:id/renovar',
  authorize('Administrador', 'Recepcionista'),
  clienteMembresiaController.renovar,
)
