    ...
    data: [
      {
        ...
        fecha_nacimiento: new Date('1998-04-15'),
      },
      {
        id_gimnasio: gym.id_gimnasio,
        nombre: 'María',
        ...
        fecha_nacimiento: new Date('2000-09-22'),
      },
      {
        id_gimnasio: gym.id_gimnasio,
        nombre: 'Luis',
    ...
    data: [
      {
        id_gimnasio: gym.id_gimnasio,
        nombre: 'Básica',
        descripcion: 'Acceso en horario regular',
        precio: 15.0,
        duracion_dias: 30,
      },
      {
    ...
    data: [
      {
        ...
        nivel: 'intermedio',
        descripcion: 'Ejercicio de empuje horizontal con barra o mancuernas.',
      },
      {
        id_gimnasio: gym.id_gimnasio,
        nombre: 'Sentadilla',
        ...
        nivel: 'avanzado',
        descripcion: 'Ejercicio compuesto de tren inferior con barra en espalda.',
      },
      {
        id_gimnasio: gym.id_gimnasio,
        nombre: 'Peso muerto',
        ...
        nivel: 'avanzado',
        descripcion: 'Levantamiento de barra desde el suelo hasta posición erguida.',
      },
    ],
  })
